...
import {registerAPI} from "../API's.js";//stored api routes
      ...
      <div className="max-w-md w-full mx-4 p-6 bg-white shadow rounded">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            required
            className="w-full border px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-purple-900"
          />
          <input
            name="email"
            type="email"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-purple-900 text-white px-4 py-2 rounded hover:bg-purple-900 transition"
          >
